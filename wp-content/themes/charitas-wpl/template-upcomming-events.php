<?php
/**
 * Template Name: Uppcoming events
 *
 * @package WordPress
 * @subpackage Charitas
 * @since Charitas 1.0
					...
					<article class="list vevent">
						<div class="short-content">
							...
							<div class="entry-meta">
								<time class="dtstart" datetime="<?php echo date('c',strtotime($event_date)); ?>"><a class="buttons time fleft" href="<?php the_permalink(); ?>"><i class="icon-calendar"></i> <?php echo date( get_option('date_format'), strtotime($event_date) ); ?> <?php _e('at', 'wplook'); ?> <?php echo $event_time; ?></a></time> 
								<?php if ( $event_url != "") { ?>
									<a class="buttons facebook fleft" href="<?php echo $event_url; ?>"><i class="icon-facebook-sign"></i> <?php _e('Facebook', 'wplook'); ?></a> 
								<?php } ?>
								<a class="buttons fright" href="<?php the_permalink(); ?>" title="<?php _e('Join us', 'wplook'); ?>"><?php _e('Join us', 'wplook'); ?></a>
							</div>
							<div class="clear"></div>
