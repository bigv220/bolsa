				...
				<div class="grid_16">
					...
					<ul class="tb-list">
						...
						<?php if ( ot_get_option('wpl_rss_link') != "") { ?>
							<li class="rss"><a href="<?php echo ot_get_option('wpl_rss_link') ?>"><i class="icon-rss"></i></a></li>
						<?php } ?>
						...
						<?php if ( ot_get_option('wpl_search_form') == "true") { ?>
						...
						<?php if ( ot_get_option('wpl_donete_link') != "") { ?>
							<li class="donate"><a href="<?php echo ot_get_option('wpl_donete_link') ?>"><?php _e('Donate', 'wplook'); ?> <i class="icon-tint"></i></a></li>
						<?php } ?>
