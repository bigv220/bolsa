			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<article class="single-publication">
						...
						<div class="entry-meta-pub">
							...
							<a target="_blank" class="buttons-download fright" href="<?php if ( $publication_file ) { echo $publication_file; } else { echo "#";} ?>" title="<?php _e('Download', 'wplook'); ?>"><i class="icon-cloud-download"></i> <?php _e('Download', 'wplook'); ?></a>
