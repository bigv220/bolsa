...
class wplook_events_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'WPlook Events',
			array( 'description' => __( 'A widget for displaying upcomming or past events', 'wplook' ), )
		);
	}
						...
						<?php while( $events->have_posts() ) : $events->the_post(); ?>
							...
							<article class="event-item">
								...
								<div class="entry-meta-widget">
									<div class="date">
										<time datetime="<?php echo date('c',strtotime($event_date)); ?>"><i class="icon-calendar"></i><?php echo date( get_option('date_format'), strtotime($event_date) ); ?> <?php _e('at', 'wplook'); ?> <?php echo $event_time; ?></time>
									</div>
									<div class="location"><i class="icon-map-marker"></i> <a href="<?php the_permalink(); ?>"><?php echo $event_address; ?></a></div>
									<?php if ( $event_url != "") { ?>
										<div class="facebook"><i class="icon-facebook-sign"></i> <a href="<?php echo $event_url; ?>"><?php _e('Facebook', 'wplook'); ?></a></div> 
									<?php } ?>
								</div>
							</article>
