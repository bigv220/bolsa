		...
		$custom_settings = array(
			...
			'settings'        => array(
				...
				array(
					...
					'settings'    => array(
						...
						array(
							...
							'type'        => 'text',
							'desc'        => '<strong>NOTICE</strong>: Choose one item from tne next list: <br />icon-facebook-sign, <br />icon-github-sign, <br />icon-twitter-sign, <br />icon-pinterest-sign, <br />icon-linkedin-sign, <br />icon-google-plus-sign, <br />icon-youtube-play',
							'std'         => 'icon-',
							'rows'        => '',
							'post_type'   => '',
							'taxonomy'    => '',
				...
				array(
					...
					'id'          => 'wpl_events_email',
					'type'        => 'text',
					'desc'        => 'Add the email address where do you want to receive information about people who want to enjoy the event.',
					'std'         => '',
					'rows'        => '',
					'post_type'   => '',
					'taxonomy'    => '',
				...
				array(
					...
					'type'        => 'text',
					'desc'        => 'Set how many words do you want to display for upcomming and past events excerpt.',
					'std'         => '40',
					'rows'        => '',
					'post_type'   => '',
					'taxonomy'    => '',
				...
				array(
					'label'       => 'Activate or deactivate PayPal donation',
					'id'          => 'wpl_activate_paypal',
					'type'        => 'select',
					'desc'        => 'Activate or deactivate the paypal donation box on cause page',
					'choices'     => array(
						array(
							'label'       => 'Activated',
							'value'       => 'activated'
				...
				array(
					...
					'id'          => 'wpl_curency_sign',
					'type'        => 'text',
					'desc'        => 'Add the currency sign for ex: $',
					'std'         => '$',
					'rows'        => '',
					'post_type'   => '',
					'taxonomy'    => '',
				...
				array(
					...
					'id'          => 'wpl_paypal_email',
					'type'        => 'text',
					'desc'        => 'You will receive donation on this email',
					'std'         => '',
					'rows'        => '',
					'post_type'   => '',
					'taxonomy'    => '',
				...
				array(
					...
					'id'          => 'wpl_thank_you_page',
					'type'        => 'custom-post-type-select',
					'desc'        => 'Select the Thank You page. After successful payment users will return to this page.',
					'std'         => '',
					'rows'        => '',
					'post_type'   => 'page',
					'taxonomy'    => '',
